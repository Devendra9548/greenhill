...
<section class="second-d-section py-0 py-md-5">
    <div class="container py-5">
        <div class="row">
            <div class="col-12 col-md-6 order-1 order-md-1">
                <img src="/assets/imgs/6.jpg" alt="Green Hills Image" width="100%">
            </div>
            <div class="col-12 col-md-6 order-2 order-md-2 d-flex align-items-center">
                <div class="d-content">
...
<section class="second-section py-0 py-md-5" id="highlights">
  <div class="container py-5">
    <div class="row">
      <div class="col-12 col-md-6 order-2 order-md-1">
        <div class="content">
          <h2 class="mt-0 mt-md-4">Project Highlights</h2>
          <div class="highlight-line"></div>
      ...
      <div class="col-12 col-md-6 order-1 order-md-2 mb-3 mb-md-0">
         <img src="/assets/imgs/7.jpeg" alt="Project Highlights" width="100%">
      </div>
    </div>
  </div>
</section>
...
<section class="third-section py-0 py-md-5">
...
<section class="py-0 py-md-5 table-section payment-section" id="pricing">
  <div class="container py-5">
  <div class="card card-modern p-3 p-md-4">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4">
      <div>
        <h2 class="fw-bold mb-1">All Plots on 42 Meter Wide Road</h2>
        <h3>Payment Plan</h3>
      </div>
    </div>
      ...
      <div class="col-md-6">
        <div class="p-0 p-md-3 pt-3 pt-md-0 bg-light rounded-4 h-100">
          ...
          <div class="d-flex justify-content-between py-2">
            ...
            <strong class="id-data">18 – 22 Feb 2026</strong>
          </div>
        </div>
      </div>
    </div>
...
<section class="highlight-section">
  <div class="container">
     ...
     <p class="m-0">सभी प्रमुख बैंकों से बैंक Loan उपलब्ध है।</p>
     <a href="#home" class="btn-web-button">Register Now</a>
  </div>
</section>

<section class="why-choose-us py-0 py-md-5">
  <div class="container py-5">
    <div class="row">
  ...
  <div class="row align-items-center g-4">
    <div class="col-lg-12 order-2 order-lg-2">
      <div class="siteplan-preview">
        <iframe src="https://docs.google.com/gview?url=https://greenhillplots.com/assets/pdfs/FINAL%20GREEN%20HILL%27S%20LAYOUT%20PLAN%2024-09-2025.pdf&embedded=true" width="100%" height="700"></iframe>
      </div>
    </div>
...
<section class="actualImage py-5" id="actualImage">
  <div class="container">
    <div class="row">
      <div class="col-12 col-md-12">
        <h2 class="section-title">Actual Site Images</h2>
        <div class="section-line"></div>
      </div>
      <div class="col-12 col-md-12">
        <div class="row">
...
<section class="highlight-section certificate-section">
  <div class="container">
     <p class="m-0">Certificate issued by Government of Rajasthan - Revenue Department</p>
     <p class="m-0">Certificate Ref. No: LC/2024-25/190392 </p>
     <a href="/assets/pdfs/LC_2024-25_190392.pdf" class="btn-web-button" target="_blnak">View</a>
  </div>
</section>

<section class="contactus-section py-0 py-md-5" id="location">
